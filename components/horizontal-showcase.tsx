            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-[10px] uppercase tracking-[0.28em] text-white/85 md:text-xs">{card.eyebrow}</p>
                </div>
                <h3 className="mt-5 max-w-md text-2xl font-semibold leading-tight text-white md:mt-6 md:text-4xl">
                  {card.title}
                </h3>
                <p className="mt-3 max-w-lg text-sm text-white/85 md:mt-4 md:text-base">{card.description}</p>
              </div>
